...
const columns = [
  ...
  { field: 'cost_in_credits', headerName: 'cost_in_credits', width:180},
  { field: 'length', headerName: 'length', width:180},
  { field: 'crew', headerName: 'crew', width:180},
  { field: 'passengers', headerName: 'passengers', width:180},
  { field: 'cargo_capacity', headerName: 'cargo_capacity', width:180},
  { field: 'starship_class', headerName: 'starship_class', width:180},
]
...
//   const [data, setData] = useState([]);
  ...
  async function getPeople(searchData) {
    ...
    try {
        ...
        setshipData(resultData.data.results);
